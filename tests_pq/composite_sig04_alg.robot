...
*** Settings ***
Documentation       All different flavors of composite signature version 04 requests. This ensures that all
...                 algorithms are supported and that the implementation can handle all the different
...                 combinations.
