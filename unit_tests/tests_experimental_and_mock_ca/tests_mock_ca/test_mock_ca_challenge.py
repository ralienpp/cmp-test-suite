...
from resources.certbuildutils import prepare_extensions, build_certificate
...
class TestMockCAChallengeHandler(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.chall_handler = ChallengeHandler(
            ...
            ca_x25519_key=cls.ca_x25519,
            ca_x448_key=cls.x448,
            ca_ecc_key=cls.ec_key,
        )
        config = {
            "ca_x25519_key": cls.ca_x25519,
            "ca_x448_key": cls.x448,
            "ca_ecc_key": cls.ec_key,
            "ca_x25519_cert": cls.x25519_cert,
            "ca_x448_cert": cls.x448_cert,
            "ca_ecc_cert": cls.ec_cert,
        }
    ...
    def _protect_msg(self, msg: PKIMessageTMP) -> PKIMessageTMP:
        return protect_pkimessage(msg, "signature",
                                  cert=self.root_cert,
                                  private_key=self.ed_key)
