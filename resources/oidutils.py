...
sig_algs = "2.16.840.1.101.3.4.3"  # pylint: disable=invalid-name
id_slh_dsa_sha2_128s = f"{sig_algs}.20"  # pylint: disable=invalid-name
id_slh_dsa_sha2_128f = f"{sig_algs}.21"  # pylint: disable=invalid-name
id_slh_dsa_sha2_192s = f"{sig_algs}.22"  # pylint: disable=invalid-name
id_slh_dsa_sha2_192f = f"{sig_algs}.23"  # pylint: disable=invalid-name
id_slh_dsa_sha2_256s = f"{sig_algs}.24"  # pylint: disable=invalid-name
id_slh_dsa_sha2_256f = f"{sig_algs}.25"  # pylint: disable=invalid-name
id_slh_dsa_shake_128s = f"{sig_algs}.26"  # pylint: disable=invalid-name
id_slh_dsa_shake_128f = f"{sig_algs}.27"  # pylint: disable=invalid-name
id_slh_dsa_shake_192s = f"{sig_algs}.28"  # pylint: disable=invalid-name
id_slh_dsa_shake_192f = f"{sig_algs}.29"  # pylint: disable=invalid-name
id_slh_dsa_shake_256s = f"{sig_algs}.30"  # pylint: disable=invalid-name
id_slh_dsa_shake_256f = f"{sig_algs}.31"  # pylint: disable=invalid-name
