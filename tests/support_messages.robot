...
CA MUST Accept CA Protocol Encryption Certificate Request
    ...
    ${genm}=    Build General Message    info_values=${info_val}    recipient=${RECIPIENT}
...
CA MUST Respond to Supported Language Tags Message
    ...
    ${genm}=    Build General Message    exclude_fields=sender,senderKID   info_values=${info_val}
...
CA MUST Reject Supported Language Tags without a value
    ...
    ${genm}=    Build General Message    recipient=${RECIPIENT}    exclude_fields=sender,senderKID
